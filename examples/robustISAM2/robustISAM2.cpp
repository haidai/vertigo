...
int main(int argc, char *argv[])
{
    ...
    //                         new PriorFactor<SwitchVariableLinear>(
    //                             Symbol('s',switchCounter), SwitchVariableLinear(1.0), switchPriorModel));
    //                 graph.push_back(switchPriorFactor);


    //                 // create switchable odometry factor
    //                 SharedNoiseModel odom_model = noiseModel::Gaussian::Covariance(e.covariance);
    //                 boost::shared_ptr<NonlinearFactor> switchableFactor(
    //                         new BetweenFactorSwitchableLinear<Pose2>(planarSLAM::PoseKey(e.i), planarSLAM::PoseKey(e.j), 
    //                             Symbol('s', switchCounter), Pose2(e.x, e.y, e.th), odom_model));
    ...
    //                 boost::shared_ptr<PriorFactor<SwitchVariableSigmoid> > switchPriorFactor(
    //                         new PriorFactor<SwitchVariableSigmoid>(
    //                             Symbol('s', switchCounter), SwitchVariableSigmoid(10.0), switchPriorModel));
    //                 graph.push_back(switchPriorFactor);

    //                 // create switchable odometry factor
    //                 SharedNoiseModel odom_model = noiseModel::Gaussian::Covariance(e.covariance);
    //                 boost::shared_ptr<NonlinearFactor> switchableFactor(
    //                         new BetweenFactorSwitchableSigmoid<Pose2>(
    //                             planarSLAM::PoseKey(e.i), 
    //                             planarSLAM::PoseKey(e.j), 
    //                             Symbol('s', switchCounter), 
    //                             Pose2(e.x, e.y, e.th), 
    //                             odom_model));
    //                 graph.push_back(switchableFactor);
    //             }
    ...
    //             boost::shared_ptr<NonlinearFactor> maxMixFactor(
    //                     new BetweenFactorMaxMix<Pose2>(
    //                         planarSLAM::PoseKey(e.i), 
    //                         planarSLAM::PoseKey(e.j), 
    //                         Pose2(e.x, e.y, e.th), odom_model, null_model, e.weight));
